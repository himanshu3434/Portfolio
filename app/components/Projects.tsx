      ...
      <div className=" max-w-[80vw] mx-auto sm:max-w-[60vw]">
        ...
        <div className=" flex flex-wrap items-center justify-center  p-4 gap-16 my-10">
          {projects.map((project) => (
            <div
              key={project.id}
              className="text-white rounded-[3rem] overflow-hidden transform hover:scale-110 transition duration-300 ease-in-out hover:ease-in-out relative bg-black-200 w-[70vw] h-[43vh] sm:w-[20vw] sm:h-[40vh]  lg:h-[46vh]  "
            >
